...
srun -K\
    ...
    python -u ./webcam-based-pupil-diameter-estimation/super_resolution/training/HAT/hat/train.py \
        -opt="./webcam-based-pupil-diameter-estimation/super_resolution/training/HAT/options/train/train_HAT_SRx2_from_scratch.yml" \
        --launcher=$LAUNCHER
...
# execution commands:
# --mem-per-cpu=5G \
# python -u ./HAT/hat/train.py
# python -m torch.distributed.launch ./HAT/hat/train.py
# torchrun ./HAT/hat/train.py
