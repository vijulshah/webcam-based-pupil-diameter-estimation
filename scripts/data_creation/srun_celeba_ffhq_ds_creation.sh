...
srun -K\
    ...
    python ./webcam-based-pupil-diameter-estimation/data_creatioon/celeba_ffhq/ds_creation.py \
        --config_file="./webcam-based-pupil-diameter-estimation/configs/celeba_ffhq_ds_creation.yml"
