...
srun -K\
    ...
    python ./webcam-based-pupil-diameter-estimation/data_creation/eyedentify/run_data_alignment.py \
        --config_file="./webcam-based-pupil-diameter-estimation/configs/tobii_and_webcam_data_alignment.yml" 
