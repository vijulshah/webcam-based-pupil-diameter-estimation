...
if __name__ == "__main__":
    ...
    img_path = f"/home/vshah/Documents/Uni/Thesis_Cluster/webcam-based-pupil-diameter-estimation/local/data/EyeDentify/Wo_SR/original/1/1/frame_20.png"
    ...
    for extraction_library in extraction_libraries:
        ...
        if result_dict is not None and len(result_dict.keys()) > 0:
            ...
            output_folder = f"/home/vshah/Documents/Uni/Thesis_Cluster/webcam-based-pupil-diameter-estimation/data_creation/features_extraction/detections/{extraction_library}"
